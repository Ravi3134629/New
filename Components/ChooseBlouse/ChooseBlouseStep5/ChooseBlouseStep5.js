...
import "./ChooseBlouseStep5.css";
// import { data1, data2, data3, data4 } from "../data";

const ChooseBlouseStep5 = ({ setBlouseChoices, blouseChoices }) => {
  const url = "./images/blouse/step5/";
  return (
    <>
      <h1>We hope you loved the design !!</h1>
      <div className="blouse-step5">
...
export default ChooseBlouseStep5;
